...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{mprx0.0.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{ngrafatencionporduccion.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{emisionesselectrico.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{emisionxtec.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{emislimp.png}
