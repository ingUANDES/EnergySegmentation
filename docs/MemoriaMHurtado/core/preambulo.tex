...
\usepackage{graphicx}
% Transitorio: las figuras de los capitulos estan en la raiz del repositorio y el resto
% de las rutas son relativas al documento. Ver docs/auditoria/PLAN_ORDEN_REPOSITORIO.md etapa 1.
\graphicspath{{../../}{./}}
...
\usepackage{booktabs}  % para \toprule
