...
% \begin{figure}[H]
%     \centering
%     \includegraphics[width=0.75\linewidth]{costo precisión gabaix.png} % la imagen está en archivo/figuras-sueltas/; moverla a figures/ si se reactiva este bloque
