...
Para facilitar la resolución mediante condiciones de complementariedad (MCP), \citeA{munoz_ethical_2022} considera dos reformulaciones alternativas:
...
% \begin{figure}[H]
%     \centering
%     \includegraphics[width=0.75\linewidth]{costo precisión gabaix.png}
