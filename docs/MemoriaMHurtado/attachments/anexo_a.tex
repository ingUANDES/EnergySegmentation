...
% \begin{figure}[H]
%     \centering
%     \includegraphics[width=0.75\linewidth]{costo precisión gabaix.png} % la imagen se eliminó en la etapa 1 del plan de orden (estaba sin uso); recuperarla de git y ponerla en figures/ si se reactiva este bloque
