...
\begin{figure}[ht!]
\begin{center}
\includegraphics[width=\textwidth]{Figures/produccion_per_year_sin_cnt.png}
...
\begin{figure}[ht!]
\begin{center}
\includegraphics[width=13cm]{Figures/generadoras.png}
...
\begin{figure}[ht!]
 \includegraphics[width=\textwidth]{Figures/cap.png}
...
\begin{figure}[h!]
  \begin{subfigure}[b]{0.5\textwidth}
    \includegraphics[width=\textwidth]{Figures/production_no_cnt_2030_annual.png}
  ...
  %
  \begin{subfigure}[b]{0.5\textwidth}
    \includegraphics[width=\textwidth]{Figures/production_cnt_2030_annual.png}
    \caption{Production per year for each technology (producer) for the base-case (no cap and trade system)}
