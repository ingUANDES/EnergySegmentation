...
\begin{figure}[H]
\centering
\includegraphics[width=0.75\linewidth]{ejemplo_1.png}
...
\begin{frame}{Escenario con costo convexo: $F(\theta) = (\theta − 3)^2 + 1$}
    \begin{figure}[H]
    \centering    \includegraphics[width=0.75\linewidth]{ejemplo_2.png}
...
\begin{frame}{Escenario con costo convexo: $F(\theta) = (\theta − 3)^2 + 1$}
    \begin{figure}[H]
    \centering    \includegraphics[width=0.75\linewidth]{planificador social profit.png}
    \caption{Escenario con costo convexo: $F(\theta) = (\theta − 3)2 + 1$}
    \label{fig:ejemplo2}
    \end{figure}
\end{frame}
...
\begin{frame}{Planificador Orientado al Bienestar Social}
    \begin{figure}[H]
    \centering    \includegraphics[width=0.75\linewidth]{planificador social bienestar.png}
    \caption{}
    \label{fig:ejemplo2}
    \end{figure}
\end{frame}
...
\begin{frame}{Evolución de la Matriz Energética (m=1, 2020-2030)}
    \centering
    \includegraphics[width=\textwidth,height=0.9\textheight,keepaspectratio]{mprx0.0.png}
