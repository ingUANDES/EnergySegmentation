...
\centering
{\faCheckCircle}\ \ Menor distancia en $m = \valMArgmin$ ($\valDistanciaArgmin$)
\quad$\Rightarrow$\quad \textbf{planificador inatento}\\[2pt]
{\scriptsize Para los análisis se usa $m = \valMSeleccionado$
($\sigma_\varepsilon = \valSigmaEpsSeleccionado$ \unidadMt, distancia $\valDistanciaSeleccionado$),
el menor $m$ con $\sigma_\varepsilon$ finito.}
\end{tcolorbox}
...
\begin{frame}{Escenario con costo convexo: $F(\theta) = (\theta − 3)^2 + 1$}
    \begin{figure}[H]
    \centering    \includegraphics[width=0.75\linewidth]{figures/ejemplo_2.png}
...
\begin{frame}{Escenario con costo convexo: $F(\theta) = (\theta − 3)^2 + 1$}
    \begin{figure}[H]
    \centering    \includegraphics[width=0.75\linewidth]{figures/planificador social profit.png}
    \caption{Escenario con costo convexo: $F(\theta) = (\theta − 3)2 + 1$}
    \label{fig:ejemplo2}
    \end{figure}
\end{frame}
...
\begin{frame}{Planificador Orientado al Bienestar Social}
    \begin{figure}[H]
    \centering    \includegraphics[width=0.75\linewidth]{figures/planificador social bienestar.png}
    \caption{}
    \label{fig:ejemplo2}
    \end{figure}
\end{frame}
