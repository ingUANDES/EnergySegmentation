...
\begin{frame}{Riesgo de Incertidumbre: Costo Social del Carbono}
    \vspace{-0.3cm} % Espacio corregido y reducido para evitar que la figura se desborde
    \begin{figure}
        \centering
        \includegraphics[
...
\begin{frame}[allowframebreaks]{Bibliografía}
    ...
    \bibliography{docs/MemoriaMHurtado/references}
