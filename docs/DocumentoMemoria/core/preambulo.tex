...
% minted retirado: la opcion outputdir estaba fijada a la ruta de Overleaf, exigia -shell-escape
% y Pygments, y ningun entorno minted se usa realmente en los capitulos.
...
\usepackage{graphicx}
% Reconcilia las dos convenciones de ruta del documento: las figuras de capitulos son
% relativas a la raiz del repositorio y el logo y las fuentes al directorio del documento.
\graphicspath{{../../}{./}}
