% =====================================================================
% shared/memoria/preambulo-base.tex
% ---------------------------------------------------------------------
% Preambulo comun de las memorias. Antes existian tres copias divergentes
% de este archivo (DocumentoMemoria, MemoriaMHurtado y la plantilla
% docs/Memoria, ya eliminada), y las tres arrastraban los mismos cuatro
% bloqueadores de compilacion. Aqui estan corregidos una sola vez:
%
%   1. \usetikzlibrary{shadows}      (shadows.blur ya no existe en PGF)
%   2. \setmainfont{TeX Gyre Termes} (Times New Roman es propietaria)
%   3. gensymb declarado en el README como dependencia
%   4. minted NO se carga aqui: solo lo usa la memoria de Hurtado, y
%      obliga a -shell-escape mas Pygments. Se carga en el documento
%      que lo necesita.
%
% Cada memoria conserva su propio core/preambulo.tex, que hace \input de
% este archivo y añade lo que es suyo: el \graphicspath, minted, y los
% paquetes que solo ella usa.
%
% Los .sty de terceros (newapa, setspace, julialogo) y las carpetas
% fonts/ y logos/ siguen en cada documento a proposito: kpathsea no
% busca en ../../shared/, y hacer que lo haga exigiria fijar TEXINPUTS,
% lo que rompe el criterio de "compilar desde la propia carpeta con
% xelatex a secas".
%
% Autoria original del preambulo: Jaime Cisternas, 2004 y 2010.
% =====================================================================
...
\usetikzlibrary{shadows} % shadows.blur no existe en las versiones actuales de PGF
...
\setmainfont{TeX Gyre Termes} % clon libre de Times; la fuente propietaria no es portable
